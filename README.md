...
**Help → Preferences → Startup → Enable auto full screen** fills the current monitor after 10 seconds without mouse, pen, touch, or keyboard activity in Whiteboard. It is off by default and waits while the window is inactive or minimized, a dialog is open, or a gesture is held. F11 and Escape retain their usual behavior; leaving full screen starts a fresh 10-second countdown.
