...
internal static class SettingsCatalog
{
    ...
    [
        ...
        new()
        {
            ...
            Category = Mode,
            Title = "Design tools",
            Summary = "Insert tab and palette, shape, connector, and text tools",
        ...
        new()
        {
            ...
            Category = Mode,
            Title = "Property bar",
            Summary = "The bar above a selection: color, thickness, fill, and font",
        ...
        new()
        {
            ...
            Summary = "Tap-selecting strokes, the lasso, two Selection settings",
        ...
        new()
        {
            ...
            Summary = "A faint grid of lines or dots behind the board",
        ...
        new()
        {
            ...
            Summary = "An Insert button and a Lasso chevron on a wider toolbar",
